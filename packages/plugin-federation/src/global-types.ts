...
declare module '@pothos/core/types' {
  ...
  export interface FieldOptionsByKind<
    ...
    ResolveReturnShape,
  > {
    ExtendedEntity: PothosSchemaTypes.ObjectFieldOptions<
      Types,
    ...
    > & {
      requires?: Selection<ResolveShape & object>;
        ...
        ResolveReturnShape
      >;
    ExternalEntity: PothosSchemaTypes.ObjectFieldOptions<
      Types,
      ParentShape,
      Type,
      Nullable,
    ...
    EntityObject: PothosSchemaTypes.ObjectFieldOptions<
      Types,
      ParentShape,
      Type,
      Nullable,
  ...
  export interface SchemaBuilder<Types extends SchemaTypes> {
    ...
    asEntity: <
      Param extends
        | PothosSchemaTypes.InterfaceRef<Types, unknown>
        | PothosSchemaTypes.ObjectRef<Types, unknown>,
      KeySelection extends Selection<object>,
    >(
      param: Param,
      options: {
        ...
        interfaceObject?: Param extends PothosSchemaTypes.ObjectRef<Types, unknown>
          ? boolean
          : never;
      },
    ) => void;
